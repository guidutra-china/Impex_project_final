        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ $invoice->currency->symbol }}{{ number_format($item->unit_cost, 2) }}</td>
                    <td class="text-right">{{ $invoice->currency->symbol }}{{ number_format($item->tax ?? 0, 2) }}</td>
                    <td class="text-right">{{ $invoice->currency->symbol }}{{ number_format($item->total_cost, 2) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
