...
class ShipmentForm
{
                ...
                Tabs::make('Tabs')
                    ->tabs([
                        ...
                        Tabs\Tab::make('Shipping Details')
                            ->schema(static::getShippingDetailsComponents()),
                        
                        Tabs\Tab::make('Dates & Financial')
                            ->schema(static::getDatesFinancialComponents()),
                        
                        Tabs\Tab::make('Measurements')
                            ->schema(static::getMeasurementsComponents()),
                        
                        Tabs\Tab::make('Additional Info')
                            ->schema(static::getAdditionalInfoComponents()),
                        
                        // Commercial Invoice Tab
                        CommercialInvoiceTab::make(),
                    ])
                    ->columnSpanFull(),
            ]);
    }
    ...
    protected static function getShippingDetailsComponents(): array
    {
        return [
            Grid::make(3)
                ->schema([
    ...
    protected static function getDatesFinancialComponents(): array
    {
        return [
            Section::make('Dates')
                ->schema([
    ...
    protected static function getMeasurementsComponents(): array
    {
        return [
    ...
    protected static function getAdditionalInfoComponents(): array
    {
        return [
            Textarea::make('notes')
