...
class SupplierObserver
{
    ...
    public function creating(Supplier $supplier): void
    {
        ...
        if (empty($supplier->supplier_code)) {
            $supplier->supplier_code = $this->generateUniqueCode($supplier->name);
        }
    }
    ...
    public function updating(Supplier $supplier): void
    {
        ...
        if ($supplier->isDirty('name') && empty($supplier->supplier_code)) {
            $supplier->supplier_code = $this->generateUniqueCode($supplier->name);
        }
    }
    ...
    protected function isCodeAvailable(string $code): bool
    {
        ...
        return !Supplier::where('supplier_code', $code)->exists();
    }
